...
@Entity
@Table(name = "package_purchase_payment")
@Data
@NoArgsConstructor
@AllArgsConstructor
@SuperBuilder
@EqualsAndHashCode(callSuper = true)
public class PackagePurchasePayment extends BaseEntity {

    @Column(name = "package_purchase_id", nullable = false, unique = true)
    ...
    @JoinColumn(name = "package_purchase_id", insertable = false, updatable = false)
    private PatientExamPackagePurchase packagePurchase;
}
