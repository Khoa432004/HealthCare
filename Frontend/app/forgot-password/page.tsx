      ...
      <div className="grid lg:grid-cols-2 gap-4 lg:gap-6 items-center min-h-[calc(100vh-1.5rem)] lg:min-h-[calc(100vh-2rem)]">
        <div className="space-y-5 sm:space-y-6 max-w-xl mx-auto lg:mx-0 order-2 lg:order-1">
          ...
          <div className="space-y-2">
            ...
            <p className="text-sm text-slate-600 leading-relaxed">Nhập email của bạn để nhận mật khẩu mới</p>
          </div>
          ...
          <div className="space-y-3">
            ...
            <div className="flex flex-col sm:flex-row space-y-2 sm:space-y-0 sm:space-x-3 pt-2">
              ...
              <Link href="/verify-otp" className="flex-1">
                <Button
                  className="inline-flex items-center justify-center gap-2 rounded-full truncate transition font-semibold select-none w-full px-4 py-3 text-sm bg-[#16a1bd] text-white shadow-md hover:bg-[#0d6171] disabled:bg-gray-300 h-auto"
                >
                  Khôi phục mật khẩu
                </Button>
              </Link>
