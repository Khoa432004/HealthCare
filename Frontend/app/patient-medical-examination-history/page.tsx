...
export default function MedicalHistory() {
  ...
  const handleDownloadPDF = (id: string) => {
    ...
    fetch(`http://localhost:8080/api/doctors/medicalexaminationhistory/${user?.id}`)
      .then(res => res.json())
                  ...
                  <CardContent className="p-4">
                    <div className="space-y-4">
                      <div className="flex gap-4 items-end">
                        ...
                        <Popover>
                            {/* PopoverTrigger: Nút sẽ kích hoạt việc mở nội dung */}
                            ...
                            {/* PopoverContent: Nội dung bên trong Popover */}
                            <PopoverContent className="w-80 p-4 bg-gray-50" align="end">                                
                                <div className="space-y-4 ">
                                    ...
                                    {/* Nút Áp dụng Filter - Quan trọng để người dùng kích hoạt tìm kiếm */}
                                    <Button 
