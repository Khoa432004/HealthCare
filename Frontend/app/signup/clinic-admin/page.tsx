      ...
      <div className="container mx-auto px-4 py-8">
        <div className="flex items-center justify-center min-h-[calc(100vh-4rem)]">
          <div className="w-full max-w-2xl bg-white/95 backdrop-blur-sm rounded-3xl shadow-xl p-8">
            ...
            <h1 className="text-3xl font-bold text-[#0b0c0c] mb-8">Clinic Admin Registration</h1>
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <Input placeholder="Enter clinic name" className="h-12" />
              </div>
              ...
              <div className="grid md:grid-cols-2 gap-4">
                ...
                <div>
                  <label className="block text-sm font-medium mb-2">Clinic License Number</label>
                  <Input placeholder="Enter license number" className="h-12" />
                </div>
              </div>
